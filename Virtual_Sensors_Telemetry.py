...
# -*- coding: utf-8 -*-
"""
Created on Sun Jan 15 00:53:52 2023
...
Colombia_MainMeter_Temp_Min = 10.0
Colombia_MainMeter_Temp_Max = 14.7
Colombia_MainMeterBattery = 94.78

Colombia_Edge_WaterReading_Min = 0.001
Colombia_Edge_WaterReading_Max = 1.176
Colombia_Edge_Temp_Min = 13.0
Colombia_Edge_Temp_Max = 19.0
...
def fnSensorDataUpdate(db_file, table_name, country):
    ...
    with sqlite3.connect(db_file) as conn:
        ...
        row_count = cursor.fetchone()[0]
        print("Amount of Sensors registered in {country}", row_count)
        ...
        if not rows:
            ...
            for row in rows:
                ...
                if country == 'Colombia' and sensorType == "Distribution":
                ...
                elif country == 'Colombia' and sensorType == "End User":
...
#fnPushCSVtoSQL('virtualSensorsList.csv','virtual_sensors.db', 'virtual_water_sensors')
#fnPrint_Database('virtual_sensors.db', 'virtual_water_sensors')
fnSensorDataUpdate('virtual_sensors.db', 'virtual_water_sensors', 'Colombia')
